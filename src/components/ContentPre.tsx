...
import { copyToClipboard } from "@/library/util";

export type ContentPreProps = {
  children: JSX.Element;
  className: string;
};

export const ContentPre = ({
  children,
  className,
  ...props
}: ContentPreProps): JSX.Element => {
  ...
  return (
    <div className="relative group">
      ...
      >
        <div className="absolute flex items-center space-x-2 top-1 right-1 m-2">
          <span
